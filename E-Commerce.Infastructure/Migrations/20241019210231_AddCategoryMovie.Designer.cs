...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Movies.MovieCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Roles.Role", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Movies.Movie", b =>
                {
                    b.HasOne("E_Commerce.Domain.Entities.Movies.MovieCategory", "MovieCategory")
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("E_Commerce.Domain.Entities.Roles.Role", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", null)
                        .WithOne()
                        .HasForeignKey("E_Commerce.Domain.Entities.Roles.Role", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
